...
urlpatterns = [
    ...
    url(r'^natural/new$', rendered_form.form_person_for_complaint, name="add_natural_person"),
    ...
    re_path(r'^complaint_nat/(?P<person_id>[1-9]\d*)/$', rendered_form.form_natural_complaint,
            name='add_natural_complaint'),
    re_path(r'^get_complaints/(?P<person_id>[1-9]\d*)/$', rendered_form.middle_form_natural_complaint,
            name='get_complaints_for_person'),
    re_path(r'^complaints_by_person/(?P<person_id>[1-9]\d*)/$', rendered_form.middle_form_natural_complaint,
