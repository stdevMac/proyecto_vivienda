...
class LocalForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'municipio': forms.Select(attrs={"placeholder": "Seleccione una Municipio.", "class": "form-control"}),
            'organismo': forms.Select(attrs={"placeholder": "Seleccione una Organismo.", "class": "form-control"}),
