    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.CharField(choices=[('Trámite', 'Trámite'), ('S', 'Solución o Resuelto'), ('PR', 'Pendiente de Respuesta'), ('PS', 'Pendiente de Solución'), ('ECNS', 'Explicada Causa de no Solución')], default='S', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Esperando aceptación del jefe', 'EAJ'), ('Esperando Respuesta de Técnico', 'ERT'), ('Finalizada', 'F'), ('Esperando Asignación', 'EA'), ('Pendiente', 'P')], default='Pendiente', max_length=20)),
                ('enter_date', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(choices=[('Esperando aceptación del jefe', 'EAJ'), ('Esperando Respuesta de Técnico', 'ERT'), ('Finalizada', 'F'), ('Esperando Asignación', 'EA'), ('Pendiente', 'P')], default='Pendiente', max_length=200)),
                ('technical_args', models.TextField()),
                ('boss_args', models.TextField()),
                ('boss_answer', models.CharField(choices=[('Trámite', 'Trámite'), ('S', 'Solución o Resuelto'), ('PR', 'Pendiente de Respuesta'), ('PS', 'Pendiente de Solución'), ('ECNS', 'Explicada Causa de no Solución')], default='S', max_length=20)),
                ('date_of_status', models.DateTimeField(auto_now_add=True)),
                ('current_status', models.CharField(choices=[('Esperando aceptación del jefe', 'EAJ'), ('Esperando Respuesta de Técnico', 'ERT'), ('Finalizada', 'F'), ('Esperando Asignación', 'EA'), ('Pendiente', 'P')], default='Pendiente', max_length=20)),
