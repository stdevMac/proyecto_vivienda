...
class Complaint(models.Model):
    ...
    status = models.CharField(choices=stat, default='Pendiente', max_length=15,verbose_name="Estado de la Queja")
...
class Accepted(models.Model):
    ...
    ans = {
        ('S', 'S'), # Solucion o Resuelto
        ('PS', 'PS'), # Pendiente de Solucion
        ('PR', 'PR'), # Pendiente de Respuesta
        ('ECNS', 'ECNS'), # Explicada Causa de no Solucion
