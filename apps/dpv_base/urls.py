...
from .views import index, login_page, recover_pass_page, logout_page, users_view, groups_view, logs_view, users_add
...
urlpatterns = [
    ...
    path('admin/users/form', users_add, name='admin_user_add'),
