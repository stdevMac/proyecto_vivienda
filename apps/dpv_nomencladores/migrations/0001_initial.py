...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(help_text='Nombre de la unidad.', max_length=50, unique=True, validators=[django.core.validators.MaxLengthValidator(50)], verbose_name='Centro de trabajo')),
                ('siglas', models.CharField(help_text='Siglas de la entidad.', max_length=5, validators=[django.core.validators.MaxLengthValidator(5)], verbose_name='Siglas')),
                ('numero', models.PositiveSmallIntegerField(blank=True, help_text='Número de la unidad', verbose_name='Número')),
