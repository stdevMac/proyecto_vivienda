...
urlpatterns = [
    ...
    re_path(r'acceptedAll/(?P<accepted_id>[0-9]\d*/$)', complaint_view.index_accepted_all, name='index_acceptes_all'),
    ...
    re_path(r'acceptedComplaint/(?P<finished_id>[1-9]\d*)/$', rendered_form.form_Accepted , name="form_finished_complaint"),
