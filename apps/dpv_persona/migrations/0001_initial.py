    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipio', models.ForeignKey(help_text='Municipio donde está ubicado el centro', on_delete=django.db.models.deletion.CASCADE, related_name='ubicacion_work', to='dpv_nomencladores.Municipio')),
            ],
            options={
